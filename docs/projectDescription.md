...
## 2\. Expert Eligibility and Consent
...
1. The last three phases are conducted as planned.  
2. The project is terminated, and only the results up to and including Phase 3 are published.  
3. An alternative form for completing phases 4, 5, and 6 is found. 
